...
public interface ServiceRepository extends JpaRepository<Service, Long> {
	...
	@Query("SELECT srv FROM Service srv  WHERE ( srv.state != org.etsi.osl.tmf.common.model.service.ServiceStateType.TERMINATED ) AND srv.endDate < CURRENT_TIMESTAMP")	
	...
	List<Service> findByDeploymentRequestID(String aDeploymentRequestID);
		...
		@Query("SELECT srv FROM Service srv "
			+ "JOIN FETCH srv.serviceCharacteristic char "
			+ "JOIN FETCH char.value val "
			+ "WHERE (srv.state = org.etsi.osl.tmf.common.model.service.ServiceStateType.ACTIVE OR "
			+ " srv.state = org.etsi.osl.tmf.common.model.service.ServiceStateType.RESERVED OR "
			+ "	srv.state = org.etsi.osl.tmf.common.model.service.ServiceStateType.FEASIBILITYCHECKED) AND "
