...
@Tag(name = "push", description = "the push API")
public interface PushApi {
    ...
    @Operation(summary = "Creates a 'Push' action and modifies a Pool", operationId = "createPush", description = "This operation runs TASK, which adds the capacity of the new resource to the resource pool.", tags={ "push", })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<ResourcePool> createPush(@Parameter(description = "The Push to be performed" ,required=true )  @Valid @RequestBody PushCreate body
) {
