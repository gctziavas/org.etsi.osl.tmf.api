...
public interface AlarmApi {
    ...
    default ResponseEntity<Alarm> createAlarm(@Parameter(description = "The Alarm to be created" ,required=true )  @Valid @RequestBody AlarmCreate body
) {
    ...
    default ResponseEntity<Void> deleteAlarm(@Parameter(description = "Identifier of the Alarm",required=true) @PathVariable("id") String id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default AlarmApi interface so no example is generated");
    ...
    default ResponseEntity<List<Alarm>> listAlarm(@Parameter(description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) String fields
...
@Parameter(hidden = true) @Valid @RequestParam Map<String, String> allParams
    ...
    default ResponseEntity<Alarm> patchAlarm(@Parameter(description = "The Alarm to be updated" ,required=true )  @Valid @RequestBody AlarmUpdate body
,@Parameter(description = "Identifier of the Alarm",required=true) @PathVariable("id") String id
    ...
    @RequestMapping(value = "/alarm/{id}",
        produces = { "application/json;charset=utf-8" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Alarm> retrieveAlarm(@Parameter(description = "Identifier of the Alarm",required=true) @PathVariable("id") String id
