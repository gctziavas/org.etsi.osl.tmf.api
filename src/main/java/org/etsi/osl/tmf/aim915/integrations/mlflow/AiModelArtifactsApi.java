...
public interface AiModelArtifactsApi {
    ...
    @Operation(
        ...
        description = "Downloads an artifact associated with an AI Model from MLflow, such as the model file itself, training data, or evaluation data.",
    ...
    ResponseEntity<Resource> downloadMlflowArtifact(
        ...
        @Parameter(in = ParameterIn.PATH, description = "Type of artifact to download: 'model', 'training_data', 'evaluation_data'", required = true, schema = @io.swagger.v3.oas.annotations.media.Schema(type = "string"))
