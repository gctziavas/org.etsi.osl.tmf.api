 ...
 */
public class ResourceStateChangeNotification extends Notification  {
  

  @JsonProperty("event")
  private ResourceStateChangeEvent event = null;

  public ResourceStateChangeNotification eventId(String eventId) {
  ...
  public ResourceStateChangeNotification event( ResourceStateChangeEvent event) {
    this.event = event;
    return this;
  }
  ...
  **/
  ...
  public ResourceStateChangeEvent getEvent() {
    return event;
  }

  public void setEvent(ResourceStateChangeEvent event) {
    this.event = event;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResourceStateChangeNotification serviceCreateNotification = (ResourceStateChangeNotification) o;
