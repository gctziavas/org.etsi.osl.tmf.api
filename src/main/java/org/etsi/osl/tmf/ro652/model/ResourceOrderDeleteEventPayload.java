...
public class ResourceOrderDeleteEventPayload   {
  @JsonProperty("resourceOrder")
  private ResourceOrder resourceOrder = null;

  public ResourceOrderDeleteEventPayload resourceOrder(ResourceOrder resourceOrder) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResourceOrderDeleteEventPayload resourceOrderDeleteEventPayload = (ResourceOrderDeleteEventPayload) o;
    return Objects.equals(this.resourceOrder, resourceOrderDeleteEventPayload.resourceOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceOrderDeleteEventPayload {\n");
