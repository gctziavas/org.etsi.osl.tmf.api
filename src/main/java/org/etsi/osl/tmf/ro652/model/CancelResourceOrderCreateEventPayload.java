...
public class CancelResourceOrderCreateEventPayload   {
  @JsonProperty("cancelResourceOrder")
  private CancelResourceOrder cancelResourceOrder = null;

  public CancelResourceOrderCreateEventPayload cancelResourceOrder(CancelResourceOrder cancelResourceOrder) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CancelResourceOrderCreateEventPayload cancelResourceOrderCreateEventPayload = (CancelResourceOrderCreateEventPayload) o;
    return Objects.equals(this.cancelResourceOrder, cancelResourceOrderCreateEventPayload.cancelResourceOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelResourceOrderCreateEventPayload {\n");
