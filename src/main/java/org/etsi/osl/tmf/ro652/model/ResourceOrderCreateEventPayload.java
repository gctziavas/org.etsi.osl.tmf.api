...
public class ResourceOrderCreateEventPayload   {
  @JsonProperty("resourceOrder")
  private ResourceOrder resourceOrder = null;

  public ResourceOrderCreateEventPayload resourceOrder(ResourceOrder resourceOrder) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResourceOrderCreateEventPayload resourceOrderCreateEventPayload = (ResourceOrderCreateEventPayload) o;
    return Objects.equals(this.resourceOrder, resourceOrderCreateEventPayload.resourceOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceOrderCreateEventPayload {\n");
